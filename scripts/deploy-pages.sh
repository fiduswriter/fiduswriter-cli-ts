...
git add .
git commit -m "Deploy @fiduswriter/cli to Forgejo Pages"
...
cd "$ROOT"
rm -rf "$BUILD_DIR"
echo "Done. Available at https://fiduswriter.pages.fiduswriter.org/fiduswriter-cli-ts/"
